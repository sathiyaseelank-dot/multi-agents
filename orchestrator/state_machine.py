...
TRANSITIONS = {
    ...
    State.BUILDING: {State.VALIDATING, State.CODE_REVIEW, State.FAILED},
    State.VALIDATING: {State.RUNNING, State.REPAIRING, State.CODE_REVIEW, State.FAILED},
    State.CODE_REVIEW: {State.REPAIRING, State.RUNNING, State.COMPLETED, State.FAILED},
